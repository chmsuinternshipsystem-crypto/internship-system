    ...
    <div class="p-6">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
            ...
            <div class="md:col-span-2">
                <span class="block text-xs font-semibold text-gray-500">{{ __('📄 Documents') }}</span>
                <div class="mt-1 flex items-center gap-3">
                    <div class="flex-1 h-2.5 bg-gray-100 rounded-full overflow-hidden">
                        <div class="h-full bg-emerald-600 rounded-full" style="width: {{ $student->doc_progress_pct }}%"></div>
                    </div>
                    <span class="text-sm font-semibold text-emerald-700 tabular-nums">{{ $student->doc_progress_pct }}%</span>
                </div>
            </div>
            <div class="md:col-span-2">
                <span class="block text-xs font-semibold text-gray-500">{{ __('📅 DTR Hours') }}</span>
                <div class="mt-1 flex items-center gap-3">
                    <div class="flex-1 h-2.5 bg-gray-100 rounded-full overflow-hidden">
                        <div class="h-full bg-blue-600 rounded-full" style="width: {{ $student->dtr_progress_pct }}%"></div>
                    </div>
                    <span class="text-sm font-semibold text-blue-700 tabular-nums">{{ $student->dtr_progress_pct }}%</span>
                </div>
            </div>
            <div class="md:col-span-2">
                ...
                <div class="mt-1 flex items-center gap-3">
                    <div class="flex-1 h-2.5 bg-gray-100 rounded-full overflow-hidden">
                        <div class="h-full bg-violet-600 rounded-full" style="width: {{ $student->journal_progress_pct }}%"></div>
                    </div>
                    <span class="text-sm font-semibold text-violet-700 tabular-nums">{{ $student->journal_progress_pct }}%</span>
                </div>
            </div>
        </div>
    </div>
