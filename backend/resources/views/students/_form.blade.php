...
<div class="space-y-4"
    ...
    <div class="form-group-float md:col-span-2">
        <input id="student_number" name="student_number" type="text" inputmode="numeric" pattern="[0-9]{8}" maxlength="8" required
               ...
               x-inputmask="studentNumber"
               onkeypress="return event.charCode >= 48 && event.charCode <= 57"
               class="float-input @error('student_number') is-invalid @enderror" autocomplete="off" placeholder=" " title="{{ __('e.g. 20220568') }}"/>
    ...
    <div class="form-group-float md:col-span-1">
        <input id="contact_number" name="contact_number" type="text" inputmode="tel"                                maxlength="16" required
