...
<form
    ...
    @if ($hxTarget)
        ...
        hx-swap="innerHTML"
        hx-push-url="true"
        hx-trigger="submit, change from:select, change from:.filter-select, change from:input[name='my_students'], change from:input[name='risk'], change from:input[name='no_company'], change from:input[name='geofenced'], keyup changed delay:{{ (int) $debounceMs }}ms from:input[name='search']"
    @elseif ($autoSubmit)
        data-search-auto="1"
