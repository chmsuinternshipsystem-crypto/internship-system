<x-app-layout>
                ...
                <div class="col-span-1">
                    <div class="flex items-center justify-between mb-3">
                     ...
                     <div id="message-inbox-column"
                           hx-trigger="refresh-inbox from:body, every 10s"
    ...
    <script>
        (function () {
            ...
            var conversationId = params.get('conversation');
            if (conversationId) {
                var base = window.location.pathname.replace(/\/+$/, '');
                var showUrl = base + '/' + conversationId + '?partial=1';
                htmx.ajax('GET', showUrl, {
                    target: '#message-conversation-panel',
                    swap: 'innerHTML'
                });
