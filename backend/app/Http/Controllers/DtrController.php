...
class DtrController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($selectedStudentId) {
            ...
            if ($selectedStudent) {
                $deployment = $selectedStudent->deployments()
                ...
                if ($deployment) {
                    ...
                    $existingDtrs = DailyTimeRecord::where('student_id', $selectedStudentId)
    ...
    public function updateTasks(Request $request)
    {
        ...
        return response()->json(['success' => true, 'message' => __('Tasks saved.')]);
    }
