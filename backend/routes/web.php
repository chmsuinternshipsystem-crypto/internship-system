...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:'.implode(',', InternshipRoles::staffPortalReadRoles()))->group(function () {
        // Literal routes before wildcard {company}
        ...
        Route::get('workflow/queue/count', [StudentDocumentController::class, 'queueCount'])->name('student-documents.queue.count');

        Route::get('announcements', [AnnouncementController::class, 'index'])->name('announcements.index');
        Route::get('announcements/{announcement}', [AnnouncementController::class, 'show'])->name('announcements.show');

        Route::get('messages/unread-count', [MessageThreadController::class, 'unreadCount'])->name('messages.unread-count');
    ...
    Route::middleware('role:'.implode(',', InternshipRoles::institutionalMonitoringRoles()))->group(function () {
        ...
        Route::get('students/{student}/tab/profile', [StudentController::class, 'tabProfile'])->name('students.tab.profile');
        Route::get('students/{student}/tab/documents', [StudentController::class, 'tabDocuments'])->name('students.tab.documents');
    ...
    // Archive — accessible to all staff roles with read access
    Route::middleware('role:'.implode(',', InternshipRoles::staffPortalReadRoles()))->group(function () {
        Route::get('archive', [\App\Http\Controllers\ArchiveController::class, 'index'])->name('archive.index');
    });
    // Archive write actions — instructor only
    Route::middleware('role:instructor')->group(function () {
        Route::post('archive/students/{student}', [\App\Http\Controllers\ArchiveController::class, 'archiveStudent'])->name('archive.students.archive');
        Route::patch('archive/students/{student}/restore', [\App\Http\Controllers\ArchiveController::class, 'restoreStudent'])->name('archive.students.restore');
        Route::post('archive/companies/{company}', [\App\Http\Controllers\ArchiveController::class, 'archiveCompany'])->name('archive.companies.archive');
        Route::patch('archive/companies/{company}/restore', [\App\Http\Controllers\ArchiveController::class, 'restoreCompany'])->name('archive.companies.restore');
        Route::post('archive/deployments/{deployment}', [\App\Http\Controllers\ArchiveController::class, 'archiveDeployment'])->name('archive.deployments.archive');
        Route::patch('archive/deployments/{deployment}/restore', [\App\Http\Controllers\ArchiveController::class, 'restoreDeployment'])->name('archive.deployments.restore');
    });
    ...
    Route::middleware('role:instructor')->group(function () {
        ...
        Route::delete('company-industries/{company_industry}', [CompanyIndustryController::class, 'destroy'])->name('company-industries.destroy');
        ...
        Route::post('required-documents/{required_document}/template', [RequiredDocumentController::class, 'uploadTemplate'])->name('required-documents.template.upload');
        Route::get('required-documents/{required_document}/template/download', [RequiredDocumentController::class, 'downloadTemplate'])->name('required-documents.template.download');
        Route::delete('required-documents/{required_document}/template', [RequiredDocumentController::class, 'destroyTemplate'])->name('required-documents.template.destroy');
        ...
        Route::get('certificates/{certificate}/regenerate', [CertificateController::class, 'regenerate'])->name('certificates.regenerate');
        Route::post('certificates/{certificate}/verify', [CertificateController::class, 'verify'])->name('certificates.verify');
        Route::get('certificates/{certificate}/download', [CertificateController::class, 'download'])->name('staff.certificates.download');
    });
